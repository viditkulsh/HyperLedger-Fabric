...
class AssetTransfer extends Contract {
    ...
    async GetAllAssets(ctx) {
        const userId = ctx.clientIdentity.getID();
        console.log(`GetAllAssets called by user: ${userId}`);
        
        let role = 'user';
        
        // For testing: since all users share the same admin certificate,
        // we'll assume anyone calling GetAllAssets is an auditor
        // In production, this would check actual certificate attributes
        role = 'auditor';
